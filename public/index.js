...
class Mune extends Component {
  ...
  addClass(event) {
    ...
    var w = obj.offsetWidth,
      h = obj.offsetHeight,
      x = (event.pageX - obj.offsetLeft - (w / 2) * (w > h ? (h / w) : 1)),
      y = (event.pageY - obj.offsetTop - (h / 2) * (h > w ? (w / h) : 1)),
    ...
    if(event.type == 'mouseover'){
      obj.classList.add("in" + class_suffix);
    }else if(event.type == 'mouseout'){
      obj.classList.add("out" + class_suffix);
    }
  ...
  render() {
    ...
    return (
      <div className="container">
          <ul>
    <li ref='singleli' onMouseOver={this.addClass} onMouseOut = {this.addClass}> <a className='normal' href='#' >
